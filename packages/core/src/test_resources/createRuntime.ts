...
/**
 * Creates a new AgentRuntime with the specified configuration parameters.
 *
 ...
 * @param {Evaluator[]} [options.evaluators] - The evaluators to be used.
 * @param {Action[]} [options.actions] - The actions to be performed.
 * @param {Provider[]} [options.providers] - The providers to be utilized.
 * @returns {Promise<{ user: User, session: { user: User }, runtime: AgentRuntime }>} - The created user, session, and runtime.
 */
